...
# Get glue_eggs catalog table data
...
for tbl, file, prefix, mapping, ctx in tbl_file:
    ...
    try:
        ...
        applymapping1 = ApplyMapping.apply(frame=datasource0, mappings=mapping,
                                           transformation_ctx="applymapping1" + ctx)
