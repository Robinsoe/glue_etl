...
args = getResolvedOptions(sys.argv, ['JOB_NAME', 'glue_db', 's3_bucket', 'svr', 'db', 'sch', 'tbl'])
sc = SparkContext()
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame=dropnullfields3, connection_type="s3", connection_options={"path": s3_path}, format="parquet", transformation_ctx="datasink4" + ctx)
job.commit()
