...
if __name__ == '__main__':
    ...
    # target_glue_db = 'aurora_bda-aurora'
    # target_s3_bucket_name = 'crcdal-glue'
    # target_s3_bucket_etc = 'source-glue'
    ...
    # Glue script name
    script_name = 'glue_script_catalog_repartition'
    ...
    for index, row in df.iterrows():
        ...
        etl_functions.create_glue_cat_repartition_etl(svr, db, sch, tbl, type, group, partition_by, target_s3_bucket_name, target_s3_bucket_etc, target_glue_db, script_name)
        # etl_functions.delete_glue_cat_repartition_etl(svr, db, sch, tbl, target_glue_db)
